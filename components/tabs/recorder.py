...
class AudioEditorTab(tk.Frame):
    ...
    def create_widgets(self):
        ...
        record_frame.columnconfigure(2, weight=2)
    ...
    def stop_recording(self):
        ...
        if self.audio_stream_record:
            try:
                ...
                if self.audio_segment is not None or not self.frames:
                    self._set_editor_controls_state(tk.NORMAL)
    ...
    def _process_recorded_audio(self):
        ...
        try:
            ...
            self.audio_file_path = "Nagrane audio"
            ...
            self.audio_segment = None
            self.audio_file_path = None
            self.file_path_label.config(text="Błąd podczas nagrywania", fg="red")
            self._set_editor_controls_state(tk.DISABLED)
        finally:
